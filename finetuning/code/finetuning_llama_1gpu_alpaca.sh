...
python finetuning.py --use_peft --peft_method lora --quantization --dataset alpaca_dataset --model_name /data/ai/models/nlp/llama/models_llama3/Meta-Llama-3-8B-hf --output_dir /data/ai/tutorial/Llama3_on_HPG/finetuning/models/1gpu/alpaca